...
deg = 64
# matches the final-signature statement ring, so one public key serves both proofs
mod = 288_230_376_151_713_349
dim = (1, 10)

# witness layout and zero padding are defined in the report
