...
#define BS_SIG_D64_L2_PROOFS 2u
#define BS_SIG_D64_EVAL_OFFSET                                              \
  (2u * (BS_LAZER_SIG_D64_DEGREE - 1u) + 512u                             \
   + 2u * BS_SIG_D64_L2_PROOFS + 1u)
#define BS_SIG_D64_EQUATIONS BS_LAZER_SIG_D64_DEGREE
#define BS_SIG_D64_EVAL_SLOTS (BS_SIG_D64_EVAL_OFFSET + BS_SIG_D64_EQUATIONS)
#define BS_SIG_D64_VARIABLES                                                \
  (2u * (BS_LAZER_SIG_D64_BOUNDED_COLUMNS + 3u))
