...
static void bs_lazer_init_once (void) {
    lazer_init ();
}
...
static int64_t center_mod_statement_q (int64_t value) {
...
static int witness_is_in_profile (const int64_t *w) {
    unsigned int i;
...
static void load_statement (polymat_t A, polyvec_t t, const int64_t *a,
                            const int64_t *c) {
